...
export default @customElement("file-selector")
                                                ...
                                                <div style="max-height: 400px; overflow-y: auto; padding: 8px; border: 1px solid #eee; border-radius: 4px;">
                                                    ...
                                                    <div class="added-files">
                                                        ${this.addedFiles.map(f => html`
                                                            <div class="file-item">
                                                                <img src="${this.getThumbnailForFile(f.file.name)}"
                                                                     alt="Icone fichier"/>
                                                    ...
                                                    <div class="form-section">
                                                        <md-outlined-text-field label="Date d'échéance"
                                                                                helper-text="Helper Text"
                                                                                .value="${this.label1}"
                                                                                @input="${(e) => this.label1 = e.target.value}"></md-outlined-text-field>
                                                        <md-outlined-text-field label="Pouet pouet"
                                                                                helper-text="Helper Text"
                                                                                .value="${this.label2}"
                                                                                @input="${(e) => this.label2 = e.target.value}"></md-outlined-text-field>
                                                    </div>
                                                </div>

                                                <!-- Bouton Valider -->
                                                <md-filled-button class="add-button"
                                                                  @click="${this.handleValidateAddedFiles}">Valider
                                                </md-filled-button>
                                            `
                                            : html`
                                                <!-- Mode Liste -->
                                                <div class="header-actions">
                                                    <div>
                                                        <p>Si votre fichier ne figure pas dans la liste, vous pouvez
                                                            l’ajouter</p>
                                                    </div>
                                                    <md-filled-button @click="${this.handleAddClick}">Ajouter
                                                    </md-filled-button>
                                                </div>
                                                <md-list>
                                                ...
                                                <md-filled-button class="add-button" @click="${this.uploadAllSelected}">
                                                    Upload
                                                </md-filled-button>
                                            `}
                        </div>
