...
export @customElement('ge-menu')
class GeMenu extends LitElement {
    static styles = css`
        :host {
            display: block;
            height: 100%;
    ...
    render() {
        return html`
            <div class="sidebar ${this.expanded ? 'expanded' : 'collapsed'}">
                <div class="header">
                    ${this.expanded ? html`
            <div class="header-title">Mon espace Créancier</div>
          ` : html``}
                ...
                <div class="sidebar-content ${this.expanded ? '' : 'icons-only'}">
                    <a href="#" class="menu-item">
                        ...
                        <span class="menu-item-text">Je suis créancier</span>
                    </a>
                    ...
                    <a href="#" class="menu-item">
                        ...
                        <span class="menu-item-text">Factures et frais</span>
                    </a>
                </div>
            </div>
        `;
